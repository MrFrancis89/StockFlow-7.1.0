...
function alternarTema() {
    ...
    salvarTema(document.body.classList.contains('dark-mode') ? 'escuro' : 'claro');
}
...
function configurarEventListeners() {
    ...
    document.getElementById('btn-enviar-estoque')?.addEventListener('click', () => { darFeedback(); compartilharEstoque(); });
    document.getElementById('btn-copiar-estoque')?.addEventListener('click', copiarEstoque);
    document.getElementById('btn-enviar-compras')?.addEventListener('click', () => { darFeedback(); compartilharComprasZap(); });
